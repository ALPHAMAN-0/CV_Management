...
namespace CvPlatform.Web.Data.Migrations
{
    ...
    [Migration("20260924214131_AddAttributeLibrary")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CvPlatform.Domain.AttributeDefinition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    NpgsqlIndexBuilderExtensions.HasOperators(b.HasIndex("NormalizedName"), new[] { "text_pattern_ops" });
            ...
            modelBuilder.Entity("CvPlatform.Domain.AttributeOption", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("CvPlatform.Domain.Profile", b =>
                {
            ...
            modelBuilder.Entity("CvPlatform.Web.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("CvPlatform.Domain.AttributeOption", b =>
                {
                    b.HasOne("CvPlatform.Domain.AttributeDefinition", null)
                        .WithMany("Options")
            ...
            modelBuilder.Entity("CvPlatform.Domain.Profile", b =>
                {
                    b.HasOne("CvPlatform.Web.Data.ApplicationUser", null)
                        .WithOne()
                        .HasForeignKey("CvPlatform.Domain.Profile", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
